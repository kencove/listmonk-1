...
-- A/B testing
DROP TYPE IF EXISTS ab_test_status CASCADE; CREATE TYPE ab_test_status AS ENUM ('draft', 'running', 'selecting_winner', 'finished', 'cancelled');
...
DROP INDEX IF EXISTS idx_ab_tests_status; CREATE INDEX idx_ab_tests_status ON ab_tests(status);
